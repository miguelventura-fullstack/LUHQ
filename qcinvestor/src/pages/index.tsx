    ...
    const createGraph = async () => {
        ...
        for (let r of dta) {
            ...
            Object.entries(obj).forEach((val) => {
                tempArr.push({ date: d3.isoParse(val[0]), value: val[1] });
            });
            map.set(r[0], tempArr);
        }
        ...
        return (
            <div className="flex  justify-center w-screen h-screen overflow-hidden bg-white relative">
                <Image
                    src={bkg}
                    alt="pp"
                    className=" absolute w-screen h-screen object-cover z-0 brightness-150"
                />
                <div className="absolute flex-col w-full z-1 justify-center mt-10">
                    <div className="flex font-sfpro w-full justify-center space-x-24 font-extrabold translate-y-2 text-gray-500">
                        <button className="tracking-[.16em] text-md ">
                            MARKETS
                        </button>
                        <button className="tracking-[.16em] text-md ">
                            TRADE
                ...
                <div className="absolute flex origin-center translate-y-[80px] w-full font-sfpro flex-col space-y-3  z-1 items-center">
                    {" "}
                    {/*Regular Text*/}
                    <Image
                        src={luhq}
                        alt="pp"
                        className="-translate-y-8 -translate-x-[510px] left-0 top-0"
                    />
                    <p className="text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pinkish to-purplish font-agxb text-center  ">
                        PROPEL YOUR PORTFOLIO
                    </p>
                    <p className="text-3xl font-light text-[#919093] text-center pb-10">
                        Revolutionize portfolio optimization with our
                        quantum-powered actively managed ETFs
                    </p>
                    <div className="flex space-x-4 justify-center">
                        <div className="transition h-14 w-48 p-1 bg-gradient-to-r from-pinkish to-purplish text-xl rounded-2xl text-black font-extrabold tracking-wider flex justify-center items-center hover:ease-out duration-150 ease-in shadow">
                            <button
                                ...
                                className="w-full h-full bg-[#3C2F60] rounded-xl text-pinkish font-extrabold tracking-wider"
                            >
                                TRADE NOW
                            </button>
                        </div>
                        <div className=" h-14 w-48 p-1 bg-gradient-to-r from-light-green to-[#68DAEE] text-xl rounded-2xl text-black font-extrabold tracking-wider flex justify-center items-center">
                            <button
                                onClick={(e) => setDisplay(1)}
                                className="w-full h-full bg-black rounded-xl text-light-green font-extrabold tracking-wider"
                            >
                                EXPLORE
                            </button>
                        </div>
                ...
                <Image
                    src={figure}
                    alt="pp"
                    className="h-[800px] w-auto translate-y-[45%] z-1 m-0"
                />
            </div>
        );
    }
        ...
        return (
            <div className="flex w-screen h-screen bg-white relative border-purplish">
                <Image
                    src={explore}
                    alt=""
                    className="absolute object-cover h-screen w-screen brightness-100 z-0"
                />
                <button
                    onClick={(e) => setDisplay(0)}
                    className="absolute left-[33%] top-10"
                >
                    <Image src={luhq} alt="pp" className="" />
                </button>
                <div className="flex absolute w-screen h-screen mt-10">
                    <div className="grid ml-20 mr-20 h-3/5 w-3/5 justify-center grid-cols-2 space-x-10 ">
                        {" "}
                        {/* The two control panels*/}
                        <div className="flex flex-col justify-start mt-10 pl-16 pr-16 pt-4 h-full w-full">
                            {" "}
                            {/* The first Panel */}
                            <p className="font-sfpro text-center text-2xl pt-2 pb-1">
                                Risk Level ({risk / 10})
                            </p>
                            <input
                                type="range"
                                ...
                                step="1"
                                value={risk}
                                className="slider w-full bg-gradient-to-r from-pinkish to-purplish h-1 mt-10 mb-10 rounded-lg"
                                id="myRange"
                                onChange={(e) =>
                                    setRisk(parseInt(e.target.value))
                                }
                            />
                            <p className="font-sfpro text-center text-2xl pt-8 pb-1">
                                Stocks to Include
                            </p>
                            <div className="w-full h-24 bg-gradient-to-bl from-pinkish to-purplish rounded-xl flex p-1">
                                <input
                                    type="text"
                                    className=" bg-backblue rounded-lg w-full text border-none"
                                    placeholder="APPL, AMAZN, etc."
                                    value={userTickers}
                        ...
                        <div className="lex flex-col justify-start mt-10 pl-16 pr-16 pt-4 h-full w-full">
                            ...
                            {/* The second Panel */}
                            <div>
                                <p className="font-sfpro text-center text-2xl pb-1">
                                    Budget
                                </p>
                                <div className="w-full h-12 bg-gradient-to-bl from-pinkish to-purplish rounded-xl flex p-1">
                                    <input
                                        type="text"
                                        className=" bg-backblue rounded-lg w-full text border-none text-center"
                                        value={budget}
                                        onChange={(e) =>
                            ...
                            <p className="font-sfpro text-center text-2xl pt-20 pb-1">
                                Stock per Combinations
                            </p>
                            <div className="flex justify-center">
                                <div className="w-1/6 h-12 bg-gradient-to-bl from-pinkish to-purplish rounded-xl flex p-1">
                                    <input
                                        ...
                                        value={stockCombo}
                                        onChange={(e) =>
                                            setCombo(parseInt(e.target.value))
                                        }
                                    />
                                </div>
                    ...
                    <div className=" grid h-[68.4%] w-2/5 mr-10 space-y-4">
                        <div className=" flex flex-col border-purplish bg-bluish border-2 space-y-16">
                            {" "}
                            {/*Display 1*/}
                            <p className="mt-3 text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pinkish to-purplish font-sfpro text-center  ">
                                Reccomended Stocks
                            </p>
                            <>
                                {recc.map((el, index) => (
